...
describe('GeometryUtils', () => {
  ...
  test('should detect rectangle overlap', () => {
    ...
    assert.ok(GeometryUtils.rectanglesOverlap(rect1, rect2), 'Overlapping rectangles should return true');
    assert.ok(!GeometryUtils.rectanglesOverlap(rect1, rect3), 'Non-overlapping rectangles should return false');
  });
